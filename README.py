# ✈️ Airways Reviews Analysis Dashboard

This project dives into customer reviews of Airways to uncover insights into passenger sentiment, regional patterns, and service quality trends. The analysis is visualized through an interactive **Tableau dashboard**.
...
| `Airways Reviews.twbx` | Tableau workbook containing interactive visual dashboards |
...
2. Open `Airways Dashboard.twbx` in **Tableau Desktop**.
